...
$(document).ready(function() {
	$(".search-button").click(function() { //click function initiates when user clicks Search
		let input = document.getElementById("userSearch").value; //value in input field is stored in variable
		if(input==="" || input === " ") {
			alert("Please enter search criteria.");
		} else {
			//value is placed in URL
			let url = "https://en.wikipedia.org/w/api.php?action=opensearch&search=" + input + "&format=json&callback=?";
